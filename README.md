...
=====================
This file describes the different files in the dataset.
Codebook describes  more information about the variables and data.
run_analysis.R script generates the tidy data set with the average of each variable for each activity and each subject.
